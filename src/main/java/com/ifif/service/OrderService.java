...
import com.ifif.dto.OrderDto;
import com.ifif.dto.OrderHistDto;
import com.ifif.dto.OrderItemDto;
import com.ifif.entity.*;
import com.ifif.repository.*;
...
public class OrderService {
    ...
    public Long order(OrderDto orderDto, String email) {
        ...
        //payment.setStatus(item.getOrderStatus());
...
//        System.out.println("가격"+orders.getFirst().getOrderPrice());
    ...
    public Long orders(List<OrderDto> orderDtoList, String email){
        ...
        // 주문서 저장
        //order.setOrderPrice(orderItemList.get(0).getOrderPrice());
        //System.out.println("0000000"+orderItemList.get(0).getOrderPrice());
